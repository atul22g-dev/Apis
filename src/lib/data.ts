...
import miniProjectsData from '@/../Projects/Mini_Projects.json';
import jsLibrariesData from '@/../Projects/Js_Libaries.json';
import moviesData from '@/../Movies/index.json';
import productsData from '@/../Products/index.json';
import backendData from '@/../Projects/Backend.json';
import repositoriesData from '@/../Projects/Repositories.json';
import appData from '@/../Projects/App.json';
import cdnsData from '@/../Projects/Cdns.json';
import wallpapersData from '@/../Wallpapers/index.json';
import phpProjectsData from '@/../Projects/PhpProjects.json';
import incompleteProjectsData from '@/../Projects/Incomplete_projects.json';
import mongodbData from '@/../Projects/MongoDB.json';
import packagesData from '@/../Projects/Packages.json';
